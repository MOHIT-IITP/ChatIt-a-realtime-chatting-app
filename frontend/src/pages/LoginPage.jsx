...
const LoginPage = () => {
  ...
  return (
    <div className="h-screen flex justify-center items-center">
      <div className="bg-white p-8 rounded-3xl shadow-xl  py-20  w-96">
        <h2 className="text-5xl font-semibold text-center text-primary mb-6">
          Login
        </h2>
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            <input
              ...
              className="w-full text-black focus:outline-none px-4 py-2 border rounded-xl  focus:ring-2 focus:ring-blue-400"
            />
          </div>
